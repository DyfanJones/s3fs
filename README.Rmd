...
<!-- badges: start -->
[![s3fs status badge](https://dyfanjones.r-universe.dev/badges/s3fs)](https://dyfanjones.r-universe.dev)
<!-- badges: end -->
...
**NOTE:** if you want change from AWS S3 to Minio and `s3_file_system` has been previously run you will need refresh the session by setting `refresh = TRUE`.
